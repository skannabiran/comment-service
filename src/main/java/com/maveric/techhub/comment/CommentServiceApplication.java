package com.maveric.techhub.comment;

import com.maveric.techhub.comment.config.AppConstants;
import com.maveric.techhub.comment.config.ApplicationProperties;
import com.maveric.techhub.comment.config.DefaultProfileUtil;
...
public class CommentServiceApplication {
	...
	public CommentServiceApplication(Environment env) {
		this.env = env;
	}
	...
	public static void main(String[] args) throws UnknownHostException {
		SpringApplication app = new SpringApplication(CommentServiceApplication.class);
